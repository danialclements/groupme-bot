...
exports.process = (message, bot) => {
	...
	if (badWords.length) {
		...
		bot.sendMessage(`${message.name}, you are fined ${currencySymbol}${fine} ${currencyName} for the violations of the verbal morality statute.  Identified words are '${badWords.join(', ')}'.  Your current balance is ${currencySymbol}${balance} ${currencyName}.`)
	}
